...
// BluemobiLibrary
#define COCOAPODS_POD_AVAILABLE_BluemobiLibrary
#define COCOAPODS_VERSION_MAJOR_BluemobiLibrary 0
#define COCOAPODS_VERSION_MINOR_BluemobiLibrary 1
#define COCOAPODS_VERSION_PATCH_BluemobiLibrary 0
...
#define COCOAPODS_VERSION_PATCH_Expecta_Snapshots 4
